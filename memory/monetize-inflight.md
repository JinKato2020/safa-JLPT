...
- **✅Build 2579/both 投入済(2026-07-28・commit 48d346f・push済・run 30294917490)**: 広告(AdMobリワード)＋聴解新音声260本(N5/N4/N3の021-040)＋係→スタッフ＋_manifest再生成 を一括。iOS→TestFlight/Android→クローズドテスト(alpha)。tsc0・pro test16/16。実広告は公開後まで出ない=今回はテスト広告確認用。方針により監視/報告しない。**次(公開時)**: iOSプライバシー申告にトラッキング追加／app-ads.txt(pub-8926100627445480)／AdMob「アプリストアにリンク」。音声260本の実費: N4残60=¥107・N3 100=¥301(Gemini2.5Flash TTS)。
