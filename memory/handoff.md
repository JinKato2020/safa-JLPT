...
## ⚠ 会話が重くなっている（自動）
- ⚠ 連続 59ターン（文脈 25万）— ループが長い
- ツール呼び出しループが長い（指示1件に対し 59ターン・ツール28回）— まとめ方を変える
