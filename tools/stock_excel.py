...
# 割増し倍数(E列): 漢字読みN5=×3(在庫410/eligible146≒2.8)。
# 文法形式=在庫問題数/各レベル文法点数(grammar.json: N5=91/N4=131/N3=186)を四捨五入。
#   N5=398/91≒4.37→×4 / N4=361/131≒2.76→×3 / N3=448/186≒2.41→×2。表記N5はユーザー指定で×3。
MULT = {('漢字読み', 'N5'): '×3', ('表記', 'N5'): '×3',
        ('文法形式', 'N5'): '×4', ('文法形式', 'N4'): '×3', ('文法形式', 'N3'): '×2'}
# 組み立て・文章の文法(E19-E24)の割増倍数=問題の文法ID数(在庫問題数)/辞書の文法ID数(grammar.json点数)。小数表示。
# 各問1件が文法IDを1つ持つ=在庫問題数がそのまま「問題の文法ID数」。DYN_MULT に含む大問はループ内で在庫/点数から算出。
GRAMMAR_PTS = {'N5': 91, 'N4': 131, 'N3': 186}
DYN_MULT = {'組み立て', '文章の文法'}
MOCK = {('漢字読み', 'N5'): 104, ('漢字読み', 'N4'): 90, ('漢字読み', 'N3'): 80,
        ...
        ('用法', 'N4'): 50, ('用法', 'N3'): 50,
        ('文法形式', 'N5'): 160, ('文法形式', 'N4'): 150, ('文法形式', 'N3'): 130,
        ('組み立て', 'N5'): 50, ('組み立て', 'N4'): 50, ('組み立て', 'N3'): 50,
        ('文章の文法', 'N5'): 50, ('文章の文法', 'N4'): 50, ('文章の文法', 'N3'): 50,
        # 読解4大問 模試プール(設問数=公式出題数×10回)。mockは在庫に数えない=この列のみ。
        ('内容理解(短文)', 'N5'): 30, ('内容理解(短文)', 'N4'): 40, ('内容理解(短文)', 'N3'): 40,
        ('内容理解(中文)', 'N5'): 20, ('内容理解(中文)', 'N4'): 40, ('内容理解(中文)', 'N3'): 60,
        ('内容理解(長文)', 'N3'): 40,
        ('情報検索', 'N5'): 10, ('情報検索', 'N4'): 20, ('情報検索', 'N3'): 20,
        # 聴解5大問 模試プール(設問数=公式出題数×10回・1問/クリップ)。mockは在庫に数えない=この列のみ。音声は後日TTS。
        ('課題理解', 'N5'): 70, ('課題理解', 'N4'): 80, ('課題理解', 'N3'): 60,
        ('ポイント理解', 'N5'): 60, ('ポイント理解', 'N4'): 70, ('ポイント理解', 'N3'): 60,
        ('概要理解', 'N3'): 30,
        ('発話表現', 'N5'): 50, ('発話表現', 'N4'): 50, ('発話表現', 'N3'): 40,
        ('即時応答', 'N5'): 60, ('即時応答', 'N4'): 80, ('即時応答', 'N3'): 90}
...
for (sec, dai, lv, st, se, uv, hb, k, ed, sh) in rows:
    ...
    if dai in DYN_MULT and lv in GRAMMAR_PTS and isinstance(st, (int, float)):
        mult = f'{st / GRAMMAR_PTS[lv]:.2f}'  # 問題の文法ID数(在庫)/辞書の文法ID数
