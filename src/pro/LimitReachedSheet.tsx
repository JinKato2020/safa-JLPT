  ...
  return (
    <SafeAreaView style={s.c}>
      <View style={s.card}>
        ...
        {/* Proへの導線(無制限)。広告での+1回は Phase 2 でこの上に足す。 */}
...
const styles = (c: ThemeColors) => StyleSheet.create({
  ...
  upgrade: { backgroundColor: c.blue, borderRadius: radius.md, paddingVertical: spacing.md, alignItems: 'center', marginTop: spacing.sm },
