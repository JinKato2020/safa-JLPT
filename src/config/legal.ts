...
// URLスラッグは小文字(zh-Hant → zh-hant)。例: https://safa-lang.com/jlpt/ja/privacy/
export const LEGAL_LANGS = ['en', 'ja', 'zh', 'zh-Hant', 'vi', 'ko', 'id', 'ne', 'th', 'bn', 'my'] as const;
...
export function legalUrl(kind: 'privacy' | 'terms', lang: string): string {
  ...
  return `https://safa-lang.com/jlpt/${l.toLowerCase()}/${kind}/`;
}
