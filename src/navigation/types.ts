...
export type RootStackParamList = {
  ...
  MockResultDetail: { level: Level; byCat: Record<string, { c: number; t: number }>; passed: boolean; elapsedMs: number };
  ...
  WordDrill: { kind: 'vProduce' | 'gBuild' | 'gMeaning' | 'vMeaning' | 'mixed'; level?: 'N5' | 'N4' | 'N3' }; // 単語タブ新形式(意味から単語/文をつくる/意味を選ぶ/語彙の意味認識/今日のオススメ=横断)
};
