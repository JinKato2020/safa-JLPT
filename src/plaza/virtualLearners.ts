...
export const VIRTUAL_LEARNERS: VirtualLearner[] = [
  ...
  { id: 'v2', nick: 'Leo', flag: '🇧🇷', level: 'N4', streak: 5, today: 15, avatar: 'm_boy1', home: { col: 30, row: 19 } },
  ...
  { id: 'v6', nick: 'Nina', flag: '🇫🇷', level: 'N4', streak: 19, today: 30, avatar: 'f_g4', home: { col: 34, row: 24 } },
