...
const files = {
  'problems/moji_goi/context_N4.json': { schema: 1, daimon: 'context', level: 'N4', languages: ['en', 'ne'],
    items: [{ id: 'cx:n4-v-1', prompt: 'p', question: 'q', answer: 'a', choices: ['a', 'b'], i18n: { en: { prompt: 'PE' }, ne: { prompt: 'PN' } } }] },
  'problems/moji_goi/synonym_N5.json': { schema: 1, daimon: 'synonym', level: 'N5', languages: ['ja'],
    items: [{ id: 'sy:n5-v-1', sentence: 's', underline: 'u', word: 'w', answer: 'a', choices: ['a', 'b'], i18n: {} }] },
...
test('rehydrateBanks: synonym は解説なし(reason/reasonNe を復元しない)', () => {
  const b = rehydrateBanks(files);
