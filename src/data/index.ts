...
import vocabFurigana from './dict/vocabFurigana.json';
...
export interface KnowledgeBankItem { level: string; daimon: string; stem: string; question: string; choices: string[]; answer: string; explain: string; ambiguous?: boolean; }
