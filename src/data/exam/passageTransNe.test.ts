...
// 2026-08-21: 続けて N3 を新方式20問へ全面差替（旧40問は没問題へ退避）。未訳 170→150（旧N3 40退避 − 新N3 20追加 = −20）。
// 2026-08-21: さらに N3 21-50 を追加（計50問）。未訳 150→180（新N3 +30）。翻訳は従来方針どおり未作成。
const KNOWN_PG_UNTRANSLATED = 180;
// ────────────────────────────────────────────────────────────────
